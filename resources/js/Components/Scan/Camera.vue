        ...
        <modal-window :showing="visible">
            ...
            <form @submit.prevent="submit_form">
                <div class="relative flex w-full flex-wrap items-stretch mb-8">
                    ...
                    <input v-on:keyup.enter="submit_form" v-model="form.qr_id" type="text" class="px-3 py-3 placeholder-slate-300 text-slate-600 relative bg-white bg-white rounded text-lg border-0 shadow outline-none focus:outline-none focus:ring w-full pl-10"/>
                </div>
                <div class="flex">
